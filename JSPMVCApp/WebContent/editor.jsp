...
<%
	...
	ArrayList<makaleGosterBean> asd = nesne.getAllMakale((String) session.getAttribute("kullaniciadi"));
	...
	//ArrayList<makaleGosterBean> asd6 = nesne.hakemAta(makaleid)();
%>
<%
...
<%
	...
	if (session.getAttribute("kullaniciadi") != null) {
		...
		out.print("Merhaba, " + kullaniciadi + "  Editor Sayfasina Hos Geldiniz...");
	} else {
		//session.invalidate();
	...
	<div class="container">
		<div class="row">
			<div class="btn-group btn-group-justified">
				<div class="btn-group">
					<button type="button" class="btn btn-nav" id="bir">
				...
				<div class="btn-group">
					<button type="button" class="btn btn-nav" id="dort">
						<span class="glyphicon glyphicon-leaf"></span>
						<p>SONUCLANAN MAKALELER</p>
					</button>
				</div>
				<div class="btn-group">
		...
		<table class="table">
			...
			<tbody>
				...
				<tr>
					...
					<td class="active"><%=e.getIceriktext()%></td>
					<td class="danger"><%=e.getTarih()%></td>
					<td><a href="DisplayServlet?makaleid=<%=e.getMakaleid()%>">
							EKLER.. </a></td>


					<td><select name="wer" id="wer" onchange="kontrol()">


							<option>Hakem Seciniz..</option>

							<%
								ArrayList<beanHakem> wer = nesne.hakemAta(e.getMakaleid());

									for (beanHakem e34 : wer) {
							%>
							<option value="<%=e34.getHakemid()%>"><%=e34.getAd()%>
								<%=e34.getSoyad()%></option>
							<%
								}
							%>
		...
		<table class="table">
			<thead>
				<tr>
					...
					<th style="font-size: 12px;">ICERIK</th>
					<th style="font-size: 12px;">GONDERIM TARIHI</th>
					<th style="font-size: 12px;">DURUM</th>
			...
			<tbody>
				...
				<tr>
					...
					<td class="danger">
						<%
							if (e.getDurum().equals("2")) {
									out.print("editor onaylandi");
								} else if (e.getDurum().equals("3")) {
									out.print("editor reddedildi");
								}
						%>
